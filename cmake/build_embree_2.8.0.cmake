...
#   embree.rc
  ...
  ${EMBREE_PATH}../common/scene_quad_mesh.cpp
  ${EMBREE_PATH}../common/scene_bezier_curves.cpp
  ${EMBREE_PATH}../common/scene_line_segments.cpp
  ...
  ${EMBREE_PATH}bvh/bvh_rotate.cpp
  ${EMBREE_PATH}bvh/bvh_refit.cpp
  ${EMBREE_PATH}bvh/bvh_builder.cpp
  ${EMBREE_PATH}bvh/bvh_builder_hair.cpp
  ${EMBREE_PATH}bvh/bvh_builder_morton.cpp
  ${EMBREE_PATH}bvh/bvh_builder_sah.cpp
  ${EMBREE_PATH}bvh/bvh_builder_twolevel.cpp
  ${EMBREE_PATH}bvh/bvh_builder_instancing.cpp
  ${EMBREE_PATH}bvh/bvh_builder_subdiv.cpp
...
IF (RTCORE_RAY_PACKETS)
  ...
  ${EMBREE_PATH}bvh/bvh_intersector_hybrid2.cpp)
ENDIF()
...
SET(EMBREE_LIBRARY_FILES_AVX
    ...
    ${EMBREE_PATH}bvh/bvh_rotate.cpp
    ${EMBREE_PATH}bvh/bvh_refit.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_hair.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_morton.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_sah.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_twolevel.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_instancing.avx.cpp
    ${EMBREE_PATH}bvh/bvh_builder_subdiv.avx.cpp
    ${EMBREE_PATH}bvh/bvh_intersector1.cpp
...
SET(EMBREE_LIBRARY_FILES_AVX512
    ...
    ${EMBREE_PATH}bvh/bvh_refit.cpp
    ${EMBREE_PATH}bvh/bvh_builder_subdiv.avx512.cpp
    ${EMBREE_PATH}bvh/bvh_intersector1.cpp)
...
OSPRAY_ADD_LIBRARY(ospray_embree${OSPRAY_LIB_SUFFIX} STATIC ${EMBREE_LIBRARY_FILES})

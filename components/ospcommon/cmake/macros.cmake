...
MACRO(OSPRAY_CREATE_LIBRARY LIBRARY_NAME)
  ...
  OSPRAY_ADD_LIBRARY(${LIBRARY_NAME} STATIC ${LIBRARY_SOURCES})
...
MACRO(OSPRAY_CREATE_APPLICATION APP_NAME)
  ...
  SET(OSPRAY_APP_LIBS ospray)
  IF(OSPRAY_BUILD_ISPC_DEVICE)
    SET(OSPRAY_APP_LIBS ${OSPRAY_APP_LIBS} ospray_module_ispc)
  ENDIF()

  ADD_EXECUTABLE(${APP_NAME} ${APP_SOURCES})
  TARGET_LINK_LIBRARIES(${APP_NAME} ${APP_LIBS} ${OSPRAY_APP_LIBS})
  IF (WIN32)

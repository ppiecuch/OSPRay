...
namespace ospray {
  ...
  */
  ...
  public:
    ...
    static TransferFunction *createTransferFunction(const std::string &type);
    static void registerTransferFunction(const std::string &type, TransferFunction *(*creationFunction)());
